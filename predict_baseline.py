...
parser.add_argument("--tokenizer", type=str, help="score output path", default='bert-base-multilingual-cased', choices = ['bert-base-multilingual-cased', 'spanish-bert-cased'])
